...
public class UI {
	...
	// codigos especiais das cores para imprimit no console.
	// funciona somente em consoles coloridos ( git bash no windows )
	//cores do texto
	...
	public static ChessPosition readChessPosition(Scanner sc) {
		try {	
			...
			// Recordando o valor adicionado pelo usuário
	...
	private static void printCapturePieces(List<ChessPiece> captured) {
		List<ChessPiece> white = captured.stream().filter(x -> x.getColor() == Color.WHITE).collect(Collectors.toList()); // filtrando todos de cor branca
		List<ChessPiece> black = captured.stream().filter(x -> x.getColor() == Color.BLACK).collect(Collectors.toList());// filtrando todos de cor preta
